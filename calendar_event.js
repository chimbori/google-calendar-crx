 ...
 * @private
 */
CalendarEvent.MAX_CHARS_PER_FIELD_ = 300;
 ...
 * @private
 */
CalendarEvent.DEFAULT_DURATION_HOURS_IF_ABSENT_ = 2;
 ...
 * @private
 */
CalendarEvent.CALENDAR_CREATE_EVENT_TPL_ =
...
/**
 * Trims all fields to have fewer than MAX_CHARS_PER_FIELD_ characters.
 * @private
 */
CalendarEvent.prototype.trimAllFieldsToMaxChars_ = function() {
  this.fields.title = utils.trimTo(this.fields.title,
      CalendarEvent.MAX_CHARS_PER_FIELD_);
  this.fields.description = utils.trimTo(this.fields.description,
      CalendarEvent.MAX_CHARS_PER_FIELD_);
  this.fields.location = utils.trimTo(this.fields.location,
      CalendarEvent.MAX_CHARS_PER_FIELD_);
};
...
CalendarEvent.prototype.inferEndTime_ = function(startTime) {
  ...
  if (startTime.getHours() === 0 && startTime.getMinutes() === 0) {
    ...
    endTime.setHours(startTime.getHours() +
        CalendarEvent.DEFAULT_DURATION_HOURS_IF_ABSENT_);
  }
  return endTime;
};
